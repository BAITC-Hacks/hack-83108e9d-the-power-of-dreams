...
flowchart TD
    ...
    D --> P07
    P07 -. "при наличии времени" .-> P90["P90 · NVIDIA, необязательно"]
```
...
| [P90](90-optional-nvidia-experiment.md) | Решение по ограниченному эксперименту | После обязательной приёмки и подготовки доставки | В изоляции; никогда не блокирует MVP |
