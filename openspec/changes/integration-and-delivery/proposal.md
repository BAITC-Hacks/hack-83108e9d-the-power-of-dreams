...
### New Capabilities
- `contractor-delivery`: reproducible local demonstration, final evidence and truthful delivery status.

### Modified Capabilities
None. Existing selection, frontend and public API requirements remain unchanged.

## Impact

README.md, .env.example if required, THIRD_PARTY.md, a small delivery verification script, architecture index and this OpenSpec change. Existing back/, front/, contracts and immutable shared v1 remain unchanged unless a reproduced acceptance defect requires a separately recorded ownership transfer. No dependency or infrastructure additions. Concurrent Docker delivery retains its own ownership and acceptance.
