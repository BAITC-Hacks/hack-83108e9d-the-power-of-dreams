...
NVIDIA appears only as an architectural contingency; the implemented recommendation path does not call it. This inventory does not claim a NVIDIA model integration, training on the catalogue, or ownership of supplied profile text.
